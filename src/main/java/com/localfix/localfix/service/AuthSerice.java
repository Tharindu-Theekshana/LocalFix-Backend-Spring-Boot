    ...
    public AuthResponse login(UserDto userDto) {
        ...
        try{
            ...
            if(authentication.isAuthenticated()){
                ...
                return new AuthResponse("User " + user.getEmail() + " logged in successfully", true,token,user.getRole(),true);
            }else{
                return new AuthResponse("User " + user.getEmail() + " logged in failed", false,null,null,false);
            }
